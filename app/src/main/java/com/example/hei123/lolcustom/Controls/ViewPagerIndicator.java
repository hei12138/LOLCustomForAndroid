...
public class ViewPagerIndicator extends LinearLayout {
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        colorNormal = a.getColor(R.styleable.ViewPagerIndicator_color_text_normal, COLOR_TEXT_NORMAL);
        colorHigh = a.getColor(R.styleable.ViewPagerIndicator_color_text_highlightcolor, COLOR_TEXT_HIGHLIGHTCOLOR);
